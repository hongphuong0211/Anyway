...
namespace Assets.HeroEditor4D.FantasyInventory.Scripts
{
    ...
    {
        public static void Setup(Assets.HeroEditor4D.Common.CharacterScripts.Character character, List<Item> equipped, CharacterAppearance appearance)
        {
        ...
        public static void Setup(Assets.HeroEditor4D.Common.CharacterScripts.Character character, List<Item> equipped)
        {
