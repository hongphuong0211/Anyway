...
namespace Assets.HeroEditor4D.Common.ExampleScripts
{
	...
	public class SortingOrderExample
	{
		...
		/// </summary>
		public static void OrderByIndex(Assets.HeroEditor4D.Common.CharacterScripts.Character front, Assets.HeroEditor4D.Common.CharacterScripts.Character back)
		{
		...
		/// </summary>
		public static void OrderByZ(Assets.HeroEditor4D.Common.CharacterScripts.Character front, Assets.HeroEditor4D.Common.CharacterScripts.Character back)
		{
		...
		/// </summary>
		public void SetupSortingOrderByY(List<Assets.HeroEditor4D.Common.CharacterScripts.Character> character)
		{
